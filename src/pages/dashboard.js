...
const joinPair = async () => {
  ...
  if (data.user1 === user.uid) {
    setStatus('You are already part of this pair.');
    return;
  }
  ...
  return (
    <div className="dashboard-container">
      ...
      <button className="dashboard-button" onClick={createPair}>
        Create New Pair
      </button>
      <div className="input-group">
        ...
        />
        <button className="dashboard-button" onClick={joinPair}>
          Join Pair
        </button>
      </div>
      <div style={{ marginTop: "20px" }}>
        <Link href="/how-it-works">
          <button className="dashboard-button">How It Works</button>
        </Link>
      </div>
